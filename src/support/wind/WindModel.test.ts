...
describe('WindModel', () => {
  ...
  describe('addAltitude', () => {
    it('should add wind data at specified altitude', () => {
      const wind = new Wind(new Knots(10), new CardinalDegree(270));
      let altitude = new Feet(1000);
      windModel.addAltitude(altitude, wind);
      
      expect(windModel.hasWindData()).toBe(true);
      expect(windModel.getMinAltitude().value).toBe(altitude.toMeters().value); // 1000 feet in meters
      expect(windModel.getMaxAltitude().value).toBe(altitude.toMeters().value);
    });

    it('should handle multiple altitudes and sort them', () => {
      const wind1 = new Wind(new Knots(5), new CardinalDegree(260));
      const wind2 = new Wind(new Knots(10), new CardinalDegree(270));
      let altitude1 = new Feet(1000);
      let altitude2 = new Feet(2000);
      
      windModel.addAltitude(altitude1, wind1);
      windModel.addAltitude(altitude2, wind2);
      
      expect(windModel.getMinAltitude().value).toBe(altitude1.toMeters().value); // 1000 feet
      expect(windModel.getMaxAltitude().value).toBe(altitude2.toMeters().value); // 2000 feet
    });

    it('should convert feet to meters internally', () => {
      const wind = new Wind(new Knots(15), new CardinalDegree(180));
      let altitude = new Feet(5000);
      windModel.addAltitude(altitude, wind);
      
      expect(windModel.getMinAltitude().value).toBe(altitude.toMeters().value); // 5000 feet in meters
    });

    it('should handle meters directly', () => {
      const wind = new Wind(new Knots(20), new CardinalDegree(90));
      let altitude = new Meters(1000);
      windModel.addAltitude(altitude, wind);
      
      expect(windModel.getMinAltitude().value).toBe(altitude.value);
    });
  });

  describe('getWindAtAltitude - No Data', () => {
    it('should return zero wind when no data is available', () => {
      const wind = windModel.getWindAtAltitude(new Feet(1000));
  ...
  describe('getWindAtAltitude - Single Altitude Point', () => {
    it('should return decayed wind for single altitude point', () => {
      const originalWind = new Wind(new Knots(20), new CardinalDegree(270));
      windModel.addAltitude(new Feet(5000), originalWind);
    ...
    it('should return proper decayed wind at intermediate altitude', () => {
      ...
      const wind = windModel.getWindAtAltitude(new Feet(2500));
  ...
  describe('getWindAtAltitude - Above Highest Altitude', () => {
    it('should return highest wind when altitude is above highest known', () => {
      const wind1 = new Wind(new Knots(10), new CardinalDegree(260));
      const wind2 = new Wind(new Knots(15), new CardinalDegree(270));
      
      windModel.addAltitude(new Feet(1000), wind1);
      windModel.addAltitude(new Feet(5000), wind2);
      
      const wind = windModel.getWindAtAltitude(new Feet(10000));
    ...
    it('should return highest wind when altitude equals highest known', () => {
      ...
      const wind = windModel.getWindAtAltitude(new Feet(5000));
  ...
  describe('getWindAtAltitude - Below Lowest Altitude', () => {
    it('should return decayed wind when altitude is below lowest known', () => {
      ...
      const wind = windModel.getWindAtAltitude(new Feet(500));
  ...
  describe('getWindAtAltitude - Interpolation', () => {
    it('should interpolate wind between two altitude points', () => {
      const wind1 = new Wind(new Knots(10), new CardinalDegree(260));
      const wind2 = new Wind(new Knots(20), new CardinalDegree(280));
      
      windModel.addAltitude(new Feet(1000), wind1);
      windModel.addAltitude(new Feet(3000), wind2);
      
      // Test at midpoint (2000 feet)
      const wind = windModel.getWindAtAltitude(new Feet(2000));
    ...
    it('should handle direction interpolation across 0 degrees', () => {
      const wind1 = new Wind(new Knots(10), new CardinalDegree(350));
      const wind2 = new Wind(new Knots(20), new CardinalDegree(10));
    ...
    it('should handle direction interpolation across 360 degrees', () => {
      const wind1 = new Wind(new Knots(10), new CardinalDegree(10));
      const wind2 = new Wind(new Knots(20), new CardinalDegree(350));
  ...
  describe('getWindAtAltitude - Multiple Altitude Points', () => {
    it('should interpolate between correct altitude ranges', () => {
      const wind1 = new Wind(new Knots(5), new CardinalDegree(260));
      const wind2 = new Wind(new Knots(10), new CardinalDegree(270));
      const wind3 = new Wind(new Knots(15), new CardinalDegree(280));
      
      windModel.addAltitude(new Feet(1000), wind1);
      windModel.addAltitude(new Feet(3000), wind2);
      windModel.addAltitude(new Feet(5000), wind3);
      
      // Test between first and second points
      const wind12 = windModel.getWindAtAltitude(new Feet(2000));
      ...
      const wind23 = windModel.getWindAtAltitude(new Feet(4000));
  ...
  describe('Utility Methods', () => {
    it('should return correct min and max altitudes', () => {
      ...
      windModel.addAltitude(new Feet(1000), new Wind(new Knots(10), new CardinalDegree(270)));
      windModel.addAltitude(new Feet(5000), new Wind(new Knots(20), new CardinalDegree(280)));
      
      expect(windModel.getMinAltitude().value).toBe(304.8); // 1000 feet in meters
      expect(windModel.getMaxAltitude().value).toBe(1524); // 5000 feet in meters
    });
  ...
  describe('Edge Cases', () => {
    it('should handle very small altitude differences', () => {
      const wind1 = new Wind(new Knots(10), new CardinalDegree(260));
      const wind2 = new Wind(new Knots(11), new CardinalDegree(261));
      
      windModel.addAltitude(new Feet(1000), wind1);
      windModel.addAltitude(new Feet(1001), wind2);
      
      const wind = windModel.getWindAtAltitude(new Feet(1000.5));
    ...
    it('should handle zero wind speed', () => {
      const wind1 = new Wind(new Knots(0), new CardinalDegree(270));
      const wind2 = new Wind(new Knots(10), new CardinalDegree(280));
    ...
    it('should handle negative altitude input gracefully', () => {
      const wind = new Wind(new Knots(20), new CardinalDegree(270));
      windModel.addAltitude(new Feet(1000), wind);
      
      const result = windModel.getWindAtAltitude(new Feet(-100));
